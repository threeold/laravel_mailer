...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     * @return void
     */
    public function send($view, array $data, $callback,$swift_other=null)
    {
        ...
        return $this->sendSwiftMessage($message,$swift_other);
    }
     ...
     * @return void
     */
    protected function sendSwiftMessage($message,$swift_other=null)
    {
        if ($this->events) {
            $this->events->fire('mailer.sending', [$message]);
        }
        $swift_ser= $this->swift;
        if($swift_other){
            $swift_ser= $swift_other;
        }
        if (! $this->pretending) {
            try {
                return $swift_ser->send($message, $this->failedRecipients);
                //return $this->swift->send($message, $this->failedRecipients);
            } finally {
                //$this->swift->getTransport()->stop();
                $swift_ser->getTransport()->stop();
            }
    ...
    public function setSwiftOtherMailer($other_swift)
    {
        $this->swift_other = $other_swift;
    }
